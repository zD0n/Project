#!/bin/bash
# IEMOCAP at 224x224, batch 32: {leaf, mel} x {cnn_vit, convnext} = 4 runs.
#
...
printf "$_summary"
echo "#"
echo "# results: results/LeafTorch_ViT/iemocap/sweep.csv  (leaf)"
echo "#          results/MelTorch_ViT/iemocap/sweep.csv   (mel)"
